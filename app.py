...
# ● 대상:마지막입력의날짜로부터과거4주
# streamlit에날짜,type,금액을입력할칸이있다.9점==============================================  0'10"
# streamlit에[입력]버튼이있다.2점============================================================  0'10"
# date,type,금액을입력해두고입력버튼을누르면구글시트에입력이잘된다.15점==========================  0'36" -- 0' 49"
# 날짜가streamlit의date_input으로구현되어있다.2점============================================  0'20"
# 종류를dropdown으로선택하도록되어있다.2점===================================================  0'24"
# 금액에숫자가아닌값이들어있는채로[입력]버튼을누르면warning을띄우고 구글시트에입력하지않고가만히있는다.5점  0'30"
# 위문제를Exception을사용해서해결한다.5점  1'18"
# 구글시트에서날짜,type,금액을읽어온다.15점============================================================  1'29" -- 1'36"
# 마지막입력의날짜로부터과거4주만읽어온다10점  0'57" -- 1'07"
# 읽어온값을streamlit에어떤형태로든보여준다.10점  0'57" -- 1'07"
# 읽어온값을오른쪽형태로보여준다.15점  0'57"
# 소비가없는주,종류는0원으로처리한다.20점  1'07"
# 요구사항에없지만추가로구현한유용한기능이있으면가산점최대10점 1'01" -- 1'07"
